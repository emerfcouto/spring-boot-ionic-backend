...
import com.emerfcouto.cursomc.domain.Endereco;
import com.emerfcouto.cursomc.domain.Estado;
import com.emerfcouto.cursomc.domain.ItemPedido;
import com.emerfcouto.cursomc.domain.Pagamento;
import com.emerfcouto.cursomc.domain.PagamentoComBoleto;
import com.emerfcouto.cursomc.domain.PagamentoComCartao;
...
import com.emerfcouto.cursomc.domain.enums.Perfil;
import com.emerfcouto.cursomc.domain.enums.TipoCliente;
...
import com.emerfcouto.cursomc.repositories.EnderecoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "emerfcouto@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "emerfcouto@hotmail.com", "53755623404", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("47363324", "83838394"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1); 
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "91745012", cli2, c2);
